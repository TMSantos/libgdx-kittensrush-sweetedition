 ...
 */
public class CheesePlatform extends Platform {

    public CheesePlatform(World b2World, float width, float height, float positionX, float positionY, int texture) {
    ...
    public void init(World world,int texture) {
        ...
        body.getFixtureList().get(0).setUserData("cheesePlatform");
